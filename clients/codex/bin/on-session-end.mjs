...
if (raw.trim().length > 0) {
  try {
    ...
    // Codex is expected to send JSON on stdin per the Stop hook schema; if not,
    // fall through with null and let the handler decide whether there's anything to do.
  }
}
